    ...
    if (empty($firstName) || empty($lastName) || empty($phone) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        try {
            ...
            if ($stmt->fetch()) {
                ...
                $stmt = $conn->prepare("INSERT INTO clients (firstName, lastName, phone, email, password) VALUES (?, ?, ?, ?, ?)");
                $stmt->execute([$firstName, $lastName, $phone, $email, $hashed_password]);
...
<div class="main-content">
    ...
    <section class="register-section">
        ...
        <form class="register-form" method="POST">
            ...
            <input type="text" id="firstName" name="firstName" placeholder="Enter your first name" value="<?php echo htmlspecialchars($firstName ?? ''); ?>" required>
            <label for="lastName">Last Name</label>
            <input type="text" id="lastName" name="lastName" placeholder="Enter your last name" value="<?php echo htmlspecialchars($lastName ?? ''); ?>" required>
