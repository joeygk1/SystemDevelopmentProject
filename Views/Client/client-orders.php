...
<body>
<header>
    <div class="logo"><a href="<?php echo dirname($path); ?>/client/home"><img
                    src="<?php echo dirname($path); ?>/Images/MagicNoBackground.png" alt="Magic Sole Logo"></a></div>
    <nav>
...
<div class="main-content">
    <section class="hero">
        <div class="hero-content"><h1>View Your Orders</h1>
            <p>Manage your bookings here.</p></div>
    </section>
            ...
            <?php } else {
                ...
                foreach ($data as $booking) {
                    ...
                    <tr>
                        ...
                        <td data-total="<?php echo htmlspecialchars($booking->getTotalPrice()); ?>">
                            $<?php echo number_format($booking->getTotalPrice(), 2); ?></td>
                        ...
                        <td>
                            ...
                            <button class="action-btn update-btn"
                                    onclick="openUpdateModal('<?php echo htmlspecialchars($booking->getBookingId()); ?>', '<?php echo htmlspecialchars($booking->getName()); ?>', '<?php echo htmlspecialchars($booking->getDropoffDate()); ?>', '<?php echo htmlspecialchars($phoneValue ?: ''); ?>', '<?php echo htmlspecialchars($booking->getPaymentMethod()); ?>', '<?php echo htmlspecialchars(json_encode($services)); ?>')">
                                Update
                            </button>
                            <button class="action-btn delete-btn"
                                    onclick="deleteOrder('<?php echo htmlspecialchars($booking->getBookingId()); ?>')">
                                Delete
                            </button>
                        </td>
                    </tr>
    ...
    <div class="modal" id="update-modal">
        <div class="modal-content">
            ...
            <label for="update-phone">Phone Number</label><input type="tel" id="update-phone" pattern="[0-9]{10}"
