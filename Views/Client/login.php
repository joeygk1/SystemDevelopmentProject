...
<script>
    ...
    const loginLink = document.querySelector('a[href*="/client/login"]');
    const logoutLink = document.querySelector('a[href*="/client/logout"]');
    ...
    document.getElementById('forgot-password-form').addEventListener('submit', function(event) {
        ...
        fetch('<?php echo dirname($path); ?>/forgot_password.php', {
            method: 'POST',
    ...
    function logout() {
        ...
        fetch('<?php echo dirname($path); ?>/client/logout', {
            method: 'POST'
        })
            .then(() => {
                if (loginLink) loginLink.style.display = 'block';
                if (logoutLink) logoutLink.style.display = 'none';
                window.location.href = '<?php echo dirname($path); ?>/client/login';
            });
    }
</script>
