    ...
    <section class="booking-form">
        ...
        <form id="bookingForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <!-- Hidden input to capture the selected time slot -->
                <input type="hidden" name="timeSlot" id="timeSlotHidden" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="file" id="shoeImages" name="shoeImage[]" multiple accept="image/*">
            </div>
            <!-- <div class="form-group">
            ...
            <label class="total-cost">
                Total Cost: $<input id="totalCost" name="totalCost" value="0" readonly style="width:50px; align-content: center">
            </label>
...
<script>
    ...
    // Generate dynamic shoe service fields based on number of shoe pairs selected
    ...
    // When a date is selected, generate time slot options (using buttons for better selection)
    document.getElementById('date').addEventListener('change', function() {
        ...
        timeSlots.forEach(slot => {
            ...
            slotDiv.addEventListener('click', () => {
                ...
                document.querySelectorAll('.time-slot').forEach(s => s.style.background = '#fff');
                slotDiv.style.background = '#f9c303';
                // Set the value to the hidden input for submission
                document.getElementById('timeSlotHidden').value = slot;
            });
