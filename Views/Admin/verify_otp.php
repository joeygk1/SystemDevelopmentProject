...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($otp)) {
        ...
        // Set clientEmail in session for non-admin users
        if (!$isAdmin) {
        ...
        $redirectUrl = $isAdmin ? dirname($path) . '/admin/admin-home' : dirname($path) . '/booking/booking'; // Redirect to booking for clients
