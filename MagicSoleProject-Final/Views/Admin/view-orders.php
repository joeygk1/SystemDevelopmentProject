...
<head>
    ...
    <title>View Orders - Magic Sole</title>
...
<div class="main-content">
    ...
    <div class="modal" id="update-modal">
        <div class="modal-content">
            ...
            <label for="update-customer-name">Customer Name</label>
            <input type="text" id="update-customer-name">
...
<script>
    ...
    function openUpdateModal(orderId) {
        ...
        document.getElementById('update-customer-name').value = order.customerName;
        document.getElementById('update-date').value = order.date;
        document.getElementById('update-email').value = order.email;
        document.getElementById('update-phone').value = order.phone;
    ...
    function saveOrder() {
        ...
        if (order) {
            order.customerName = document.getElementById('update-customer-name').value;
            order.date = document.getElementById('update-date').value;
            order.email = document.getElementById('update-email').value;
            order.phone = document.getElementById('update-phone').value;
